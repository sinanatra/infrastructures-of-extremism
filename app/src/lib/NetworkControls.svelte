...
<header
  class="absolute left-1/2 top-4 z-20 flex w-fit max-w-[calc(100%-1rem)] -translate-x-1/2 flex-wrap items-center justify-between gap-4 rounded-full bg-black p-2 px-4"
>
